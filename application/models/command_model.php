...
class Command_model extends MY_Model
{
    ...
    public function getByPK($command_id)
    {
        ...
        $command = $raw ? new CommandPeer ( $raw ) : false;
     ...
     * @param string $type 命令类型  CommandPeer::TYPE_xxxx
     * @param array $data 命令参数
...
class CommandPeer extends BasePeer
{
    ...
    public function save()
    {
        ...
        CommandPeer::model ()->save ( $this );
    }
    public function delete()
    {
        CommandPeer::model ()->delete($this);
    }
    /**
     *
