<?php
class WeatherAirQualityIndexAppTriggerPeer extends AppTriggerPeer
{
    use app_parameter;
    ...
    {
        $html = $this->triggerView ( 'WeatherAirQualityIndexAppTriggerPeer', array ('command' => $this ), true );
        return $html;
    }
    /**
     * (non-PHPdoc)
    ...
    public function execute($data = null)
    {
        ...
        // TODO WeatherAirQualityIndexAppTriggerPeer::execute
    }
    /*
