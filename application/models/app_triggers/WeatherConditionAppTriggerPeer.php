<?php
class WeatherConditionAppTriggerPeer extends AppTriggerPeer
{
    use app_parameter;
    ...
    {
        $html = $this->triggerView ( 'WeatherConditionAppTriggerPeer', array ('command' => $this ), true );
        return $html;
    }
    /**
     * (non-PHPdoc)
    ...
    public function execute($data = null)
    {
        ...
        // TODO WeatherConditionAppTriggerPeer::execute
    }
    /*
