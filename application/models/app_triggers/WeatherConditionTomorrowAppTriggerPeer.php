<?php
class WeatherConditionTomorrowAppTriggerPeer extends AppTriggerPeer
{
    use app_parameter;
    ...
    {
        $html = $this->triggerView ( 'WeatherConditionTomorrowAppTriggerPeer', array ('command' => $this ), true );
        return $html;
    }
    /**
     * (non-PHPdoc)
    ...
    public function execute($data = null)
    {
        ...
        // TODO WeatherConditionTomorrowAppTriggerPeer::execute
    }
    /*
