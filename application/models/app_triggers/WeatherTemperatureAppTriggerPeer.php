<?php
class WeatherTemperatureAppTriggerPeer extends AppTriggerPeer
{
    use app_parameter;
    ...
    {
        $html = $this->triggerView ( 'WeatherTemperatureAppTriggerPeer', array ('command' => $this ), true );
        return $html;
    }
    /**
     * (non-PHPdoc)
    ...
    public function execute($data = null)
    {
        ...
        // TODO WeatherTemperatureAppTriggerPeer::execute
    }
    /*
