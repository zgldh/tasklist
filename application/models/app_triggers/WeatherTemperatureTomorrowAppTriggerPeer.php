<?php
class WeatherTemperatureTomorrowAppTriggerPeer extends AppTriggerPeer
{
    use app_parameter;
    ...
    {
        $html = $this->triggerView ( 'WeatherTemperatureTomorrowAppTriggerPeer', array ('command' => $this ), true );
        return $html;
    }
    /**
     * (non-PHPdoc)
    ...
    public function execute($data = null)
    {
        ...
        // TODO WeatherTemperatureTomorrowAppTriggerPeer::execute
    }
	/* (non-PHPdoc)
