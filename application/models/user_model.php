 ...
 * @property string $password = '' 密码(md5过的)
 * @property string $email = '' 电子邮件
 * @property string $reg_datetime = '' 注册日期
 * @property string $auto_login_token = null 自动登录令牌
 * @property string $auto_login_expire = null 自动登录令牌过期日期
 */
