...
class NavBar
{
	...
	private $_header_title = null;
	private $_back_btn_url = null;
	private $_back_btn_title = null;
	 ...
	 * @param string $str
	 */
	public function setHeaderTitle($str)
	{
		$this->_header_title = $str;
	}
	 ...
	 * @param string $title
	 */
	public function setBackBtn($url, $title = null)
	{
		$this->_back_btn_url = $url;
		$this->_back_btn_title = $title;
	}
	/**
	 * 去掉返回按钮
	 */
	public function removeBackBtn()
	{
		$this->setBackBtn(null,null);
	}
	public function issetBackBtn()
	{
		if($this->_back_btn_url)
		{
			return true;
		}
		return false;
	...
	{
		return $this->_back_btn_url;
	}
	public function getBackBtnTitle()
	{
		return $this->_back_btn_title;
	}
}
